...
def add_items(request, bill_id):
    ...
    if request.method == "GET":
        ...
        return render(request, "bills/add_items.html", {"bill": bill, "items": items})
...
def customer_monthly_statement(request):
    ...
    return render(request, 'bills/customer_monthly_statement.html', {
        'bills': bills,
...
def customer_statement(request):
    ...
    return render(request, 'bills/customer_statement.html', {
        'bills': bills,
...
def bill_detail(request, bill_id):
    ...
    return render(request, 'bills/bill_detail.html', {'bill': bill, 'payments': payments, 'returns': returns})
...
def view_customers(request):
    ...
    return render(request, "bills/view_customers.html", {"customers": customer_data, "q": q})
...
def generate_bill(request, bill_id):
    ...
    return render(request, 'bills/generate_bill.html', {
        'bill': bill,
        'items': items,
...
def add_customer(request):
    ...
    return render(request, 'bills/add_customer.html')
...
def edit_customer(request, customer_id):
    ...
    return render(request, 'bills/edit_customer.html', {'customer': customer})
...
def delete_customer(request, customer_id):
    ...
    return render(request, "bills/delete_customer.html", {"customer": customer})
...
def two_invoices_view(request, customer_id):
    ...
    return render(request, "bills/generate_bill_double.html", context)
@login_required
@require_POST
